  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <KPIbox label="Total cost" value={`$${totalCostAllTime.toFixed(2)}`} />
        <KPIbox
        ...
        <div className="relative h-36 sm:h-40 md:h-44 lg:h-52 border border-gray-200 rounded-lg overflow-hidden md:col-span-2">
